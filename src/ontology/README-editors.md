...
To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/stephenrjones/triffo) for details.
 ...
 * https://github.com/stephenrjones/triffo/releases
 * https://github.com/stephenrjones/triffo/releases/new
...
what is in the `owl:versionIRI` of the derived triffo.owl (`data-version` in
triffo.obo). This will be today's date.
...
Check the build status here: [![Build Status](https://travis-ci.org/stephenrjones/triffo.svg?branch=master)](https://travis-ci.org/stephenrjones/triffo)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/stephenrjones](https://travis-ci.org/profile/stephenrjones)
 2. click the "Sync account" button
 3. Click the tick symbol next to triffo
